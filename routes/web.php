...
use App\Http\Controllers\Admin\{GalleryController,ServiceController, BlogController, ProductController};
...
// Services
  ...
  Route::post('services-create', [ServiceController::class, 'createServices'])->name('services_create');
  Route::get('services-create', [ServiceController::class, 'addServices'])->name('services_create');
  Route::get('services-edit/{id}', [ServiceController::class, 'editServices'])->name('services_edit');
  Route::get('services-data', [ServiceController::class, 'dataServices'])->name('services_data');
  // Features
...
// Blogs Category
  ...
  // ===============
  // Blogs Category
  Route::get('product-category', [ProductController::class, 'category'])->name('product_category');
  Route::post('product-category-create', [ProductController::class, 'createCategory'])->name('product_category_create');
  Route::get('product-category-create', [ProductController::class, 'addCategory'])->name('product_category_create');
  Route::get('product-category-edit/{id}', [ProductController::class, 'editCategory'])->name('product_category_edit');
  Route::get('product-category-data', [ProductController::class, 'dataCategory'])->name('product_category_data');
  // Blog
  Route::get('product', [ProductController::class, 'product'])->name('product');
  Route::post('product-create', [ProductController::class, 'createProduct'])->name('product_create');
  Route::get('product-create', [ProductController::class, 'addProduct'])->name('product_create');
  Route::get('product-edit/{id}', [ProductController::class, 'editProduct'])->name('product_edit');
  Route::get('product-data', [ProductController::class, 'dataProduct'])->name('product_data');
  // ===============
...
// Faq
  ...
  // productEnquiry
  Route::get('product-enquiry', [DashboardController::class, 'productEnquiry'])->name('productEnquiry');
  Route::get('productEnquiry-data', [DashboardController::class, 'dataProductEnquiry'])->name('ProductEnquiry_data');
...
Route::post('productEnquiry-create', [UserDashboardController::class, 'createProductEnquiry'])->name('productEnquiry_create');
...
// Route::get('shop-details', [IndexController::class, 'shopDetails'])->name('front.shopDetails');
// Route::get('shop/{id}/{slug}', [IndexController::class, 'shop'])->name('front.shop');
// Route::get('shopDetails/{slug}', [IndexController::class, 'shopDetails'])->name('front.shopDetails');

// Route::get('shop/{id}/{slug}', [IndexController::class, 'shop'])->name('front.shop');
// Route::get('shop-details/{slug}', [IndexController::class, 'shopDetails'])->name('front.shopDetails');
...
// products
Route::get('product', [IndexController::class, 'product'])->name('front.product');
Route::get('product/{id}/{slug}', [IndexController::class, 'product'])->name('front.product_category');
Route::get('product-details/{slug}', [IndexController::class, 'productDetails'])->name('front.product_details');
...
// productEnquiry
Route::get('product-enquiry', [IndexController::class, 'productEnquiry'])->name('front.productEnquiry');
// Route::get('invest', [IndexController::class, 'invest'])->name('front.invest');
// Route::get('offers', [IndexController::class, 'offers'])->name('front.offers');
// Route::get('accomoditions', [IndexController::class, 'rooms'])->name('front.rooms');
// Route::get('accomodition_details/{slug}', [IndexController::class, 'serviceDetails'])->name('front.service_details');
