...
use App\Models\User\ProductEnquiry;
...
class UserDashboardController extends Controller
{
    ...
    public function createProductEnquiry(Request $request)
    {
        $productEnquiry = new ProductEnquiry();
		
        $productEnquiry->name= $request->name;
        $productEnquiry->email= $request->email;
        $productEnquiry->phone= $request->phone;
        $productEnquiry->subject= $request->subject;
        $productEnquiry->quantity= $request->quantity;
        $productEnquiry->price= $request->price;
        $productEnquiry->message= $request->message;
        // $data = [
        //     'name' => $request->name,
        //     'email' => $request->email,
        //     'phone' => $request->phone,
