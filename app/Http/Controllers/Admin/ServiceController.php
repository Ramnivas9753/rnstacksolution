...
class ServiceController extends Controller
{
    ...
    public function dataServices(Request $request)
    {
        ...
        foreach($data as $key => $item){
            $data[$key]->image = '<img loading="lazy" src="'.url('storage/app/'.$item->icon).'" height="80px" width="80px"  onerror="this.onerror=null;this.src=\''.asset("assets/images/defaultimg.webp").'\';">';
            $data[$key]->banner = '<img loading="lazy" src="'.url('storage/app/'.$item->banner).'" height="80px" width="80px"  onerror="this.onerror=null;this.src=\''.asset("assets/images/defaultimg.webp").'\';">';
