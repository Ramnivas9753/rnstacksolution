                    ...
                    <div class="form-validation">
                        <form action="{{ route('admin.business_setting_update') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <div class="col-xl-12">
                                ...
                                <small class="">This image is visible in site image. <strong class="text-danger">Use 1000*1513px sizes image</strong></small>
                                <embed src="{{ url('storage/app/' . $settings->image_baner) }}" alt="{{$settings->site_name}}" class="mt-1 img-thumbnail" width="20%" onerror="this.onerror=null;this.src='{{ asset('assets') }}/images/defaultimg.webp';">
                            </div>
                            {{-- <small class="">This image is visible in site image. <strong class="text-danger">Use 1000*1513px sizes image</strong></small> --}}
                            {{-- <div class="col-xl-12">
                            ...
                            <small class="">This image is visible in site image. <strong class="text-danger">Use 500*500 sizes image</strong></small>
                            {{-- <div class="col-xl-12">
