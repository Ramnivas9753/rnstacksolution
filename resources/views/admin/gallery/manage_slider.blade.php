                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <img src="@if(isset($slider)) {{ url('storage/app/'.$slider->image)}}" alt="{{$slider->title}}" @endif class="img-thumbnail" width="200px"
                                        onerror="this.onerror=null;this.src='{{ asset('assets') }}/images/defaultimg.webp';" style="aspect-ratio:2/2">
                                </div>
                                
                                <div class="col-xl-6">
                                    <label for="Video" class="col-form-label">Video<span class="text-danger">*</span></label>
                                    <input type="file" name="video" id="video" @if(!isset($slider)) required @endif class="form-control" accept="video/*">
                                     <small class="">This Video is visible in site Video. <strong class="text-danger">Use 1920*1280px sizes Video</strong></small>
                                    <div class="invalid-feedback">Please enter a image.</div>
                                    <video width="320" height="240" controls>
                                        <source src="@if(isset($slider)) {{ url('storage/app/'.$slider->video)}} @endif" type="video/mp4">
