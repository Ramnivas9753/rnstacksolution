            ...
            <div class="px-3 container-fluid px-md-5">
                <div class="row">
                    <div class="col-lg-7 col-md-6">
                        ...
                        <iframe loading="lazy"  width="100%" height="315" src="{{$settings->video_link}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="lazyload"></iframe>
						</div>
                    </div>
                    <div class="col-lg-5 col-md-6">
                        <div class="text-center app-box" style="margin-top: 0px;border: #ff9900 2px solid;padding: 21px;margin-bottom: 2%;">
                            <h4>Registere Here</h4>
                            <img loading="lazy" src="{{asset('frontend-assets/images/heartbeat.png')}}" alt="{{business_setting('site_name')}}" ><br />
